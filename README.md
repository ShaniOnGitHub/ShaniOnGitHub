...
### AI Engineer | Backend Developer | RAG and Agentic Systems
...
| AI & LLM Systems | Backend & Data | Interfaces & Engineering |
|---|---|---|
| ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) **Python** | ![FastAPI](https://img.shields.io/badge/FastAPI-005571?style=flat-square&logo=fastapi) **FastAPI** | ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white) **Streamlit** |
| ![RAG](https://img.shields.io/badge/RAG-Pipelines-00BFFF?style=flat-square) **RAG Pipelines** | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) **PostgreSQL** | ![Gradio](https://img.shields.io/badge/Gradio-FFD21E?style=flat-square&logoColor=black) **Gradio** |
| ![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square&logo=langchain&logoColor=white) **LangChain** | ![SQLAlchemy](https://img.shields.io/badge/SQLAlchemy-D71F00?style=flat-square) **SQLAlchemy** | ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) **Next.js** |
| ![LlamaIndex](https://img.shields.io/badge/LlamaIndex-000000?style=flat-square) **LlamaIndex** | ![Alembic](https://img.shields.io/badge/Alembic-6B7280?style=flat-square) **Alembic** | ![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black) **React** |
| ![ChromaDB](https://img.shields.io/badge/ChromaDB-4B0082?style=flat-square) **ChromaDB** | ![REST APIs](https://img.shields.io/badge/REST_APIs-005571?style=flat-square) **REST APIs** | ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) **Git** |
| ![pgvector](https://img.shields.io/badge/pgvector-336791?style=flat-square) **pgvector** | ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) **Docker** | ![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-2088FF?style=flat-square&logo=github-actions&logoColor=white) **GitHub Actions** |
| ![Groq](https://img.shields.io/badge/Groq_API-f55036?style=flat-square) **Groq API** | ![Pydantic](https://img.shields.io/badge/Pydantic-E92063?style=flat-square&logo=pydantic&logoColor=white) **Pydantic** | ![pytest](https://img.shields.io/badge/pytest-0A9EDC?style=flat-square&logo=pytest&logoColor=white) **pytest** |
| ![Agent Workflows](https://img.shields.io/badge/Agent_Workflows-8A2BE2?style=flat-square) **Agent Workflows** | ![Redis](https://img.shields.io/badge/Redis-DC382D?style=flat-square&logo=redis&logoColor=white) **Redis** | ![CI Workflows](https://img.shields.io/badge/CI_Workflows-2E8B57?style=flat-square) **CI/CD Workflows** |
...
![Roshaan's GitHub Contribution Snake](https://raw.githubusercontent.com/ShaniOnGitHub/ShaniOnGitHub/output/github-contribution-grid-snake-dark.svg#gh-dark-mode-only)
![Roshaan's GitHub Contribution Snake](https://raw.githubusercontent.com/ShaniOnGitHub/ShaniOnGitHub/output/github-contribution-grid-snake.svg#gh-light-mode-only)
